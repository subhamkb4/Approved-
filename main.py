...
API_ID = '23371219'
API_HASH = 'f25acab0a2ca7a4ada931d45fd0269cd'
BOT_TOKEN = '8200903456:AAGZkHr622lSX7Eo0JskWMpDthTZIZxpdV0'
CHANNEL_LOGS = '-1003222060363'
    ...
    with Database() as db:
        if chat_id == -1001897182152:
            async for member in m.chat.get_members():
                ...
                await client.send_message(-1003222060363, f"<b>User eliminado: @{info['USERNAME']}</b>")
